...
public class FavoritoAdapter extends ArrayAdapter<Gato> {
    ...
    public FavoritoAdapter(Context context, List<Gato> listaGatosRecebida, Boolean favorito) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (this.listaGatos != null && !this.listaGatos.isEmpty()){
            if (this.listaGatos.get(position) != null){
                if (this.listaGatos.get(position).getUrl() == null ||
                        (this.listaGatos.get(position).getUrl() != null
                                && this.listaGatos.get(position).getUrl().equals("N"))){
                    //Aqui ocorre a carga das imagens quando salvas no BD Realm;
                    if (this.listaGatos.get(position).getFoto() != null){
                        ImageView imageView = (ImageView) view.findViewById(R.id.imagemGato);
                        byte[] outImage = this.listaGatos.get(position).getFoto();
