package br.com.andersonmatte.olhaogato.base;
...
import br.com.andersonmatte.olhaogato.activities.FavoritosActivity;
import br.com.andersonmatte.olhaogato.activities.GatoActivity;
import br.com.andersonmatte.olhaogato.activities.HomeActivity;
import br.com.andersonmatte.olhaogato.adapter.FavoritoAdapter;
import br.com.andersonmatte.olhaogato.adapter.GatoAdapter;
...
public class ActivityMenuBase extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_gatos:
                Intent b = new Intent(ActivityMenuBase.this, GatoActivity.class);
                startActivity(b);
                break;
    ...
    //Popula a listView com as imagens dos gatos.
    public void populaListViewGatos(List<Gato> listaGatosRecebida, Boolean favorito){
        ListView listView = (ListView) findViewById(R.id.listView);
        if (favorito){
            final FavoritoAdapter adapter = new FavoritoAdapter(this, listaGatosRecebida, favorito);
            listView.setAdapter(adapter);
        } else {
            final GatoAdapter adapter = new GatoAdapter(this, listaGatosRecebida, favorito);
            listView.setAdapter(adapter);
        }
    }
